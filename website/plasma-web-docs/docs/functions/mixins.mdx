...
import { FocusProps, OutlinedProps, addFocus } from '@sberdevices/plasma-web';
...
```tsx
import styled from 'styled-components';
import { BlurProps, applyBlur } from '@sberdevices/plasma-web';
...
```tsx
import styled from 'styled-components';
import { DisabledProps, applyDisabled } from '@sberdevices/plasma-web';
...
```tsx
import styled from 'styled-components';
import { InteractionProps, applyInteraction } from '@sberdevices/plasma-web/mixins';
...
```tsx
import styled from 'styled-components';
import { RoundnessProps, applyRoundness } from '@sberdevices/plasma-web';
...
```tsx
import styled from 'styled-components';
import { ViewProps, applyView } from '@sberdevices/plasma-web';
...
```tsx
import styled from 'styled-components';
import { applyEllipsis } from '@sberdevices/plasma-web';
