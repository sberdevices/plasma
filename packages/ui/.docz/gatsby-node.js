...
exports.createPagesStatefully = (args) => {
    const createPagesStatefully = get(gatsbyNodeCustom, 'createPagesStatefully', NO_OP);
...
exports.createSchemaCustomization = (args) => {
    const createSchemaCustomization = get(gatsbyNodeCustom, 'createSchemaCustomization', NO_OP);
    return createSchemaCustomization(args);
};

exports.generateSideEffects = (args) => {
    const generateSideEffects = get(gatsbyNodeCustom, 'generateSideEffects', NO_OP);
    return generateSideEffects(args);
};

exports.onCreateBabelConfig = (args) => {
    const onCreateBabelConfig = get(gatsbyNodeCustom, 'onCreateBabelConfig', NO_OP);
...
exports.onCreateWebpackConfig = (args) => {
    const onCreateWebpackConfig = get(gatsbyNodeCustom, 'onCreateWebpackConfig', NO_OP);
...
exports.onPreExtractQueries = (args) => {
    const onPreExtractQueries = get(gatsbyNodeCustom, 'onPreExtractQueries', NO_OP);
...
exports.resolvableExtensions = (args) => {
    const resolvableExtensions = get(gatsbyNodeCustom, 'resolvableExtensions', DEFAULT_RESOLVABLE_EXTENSIONS);
    return resolvableExtensions(args);
};

exports.setFieldsOnGraphQLNodeType = (args) => {
    const setFieldsOnGraphQLNodeType = get(gatsbyNodeCustom, 'setFieldsOnGraphQLNodeType', () => ({}));
