...
import { DeviceDetectionProvider } from '../Device'
...
<Playground>
    {() => {
         ...
         * В корне приложения необходимо разместить DeviceDetectionProvider.
         ...
         */
        return (
            <DeviceDetectionProvider detectDeviceCallback={() => 'sberBox'}>
                <ThemeBackground>
                    <Container>
