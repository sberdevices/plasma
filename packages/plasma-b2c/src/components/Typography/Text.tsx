...
export const TextL = styled.div<SpacingProps & BoldProps>`
    ${applyHyphens}
    ${applySpacing}
    ${({ bold }) => (bold ? textLBold : textL)}
`;
export const TextM = styled.div<SpacingProps & BoldProps>`
    ${applyHyphens}
    ${applySpacing}
    ${({ bold }) => (bold ? textMBold : textM)}
`;
export const TextS = styled.div<SpacingProps & BoldProps>`
    ${applyHyphens}
    ${applySpacing}
    ${({ bold }) => (bold ? textSBold : textS)}
`;
export const TextXS = styled.div<SpacingProps & BoldProps>`
    ${applyHyphens}
    ${applySpacing}
