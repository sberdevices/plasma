...
export const standard: InterpolationFunction<{}> = () => css`
    :root {
        ...
        --plasma-typo-body-l-font-family: var(--plasma-typo-display-font-family);
        --plasma-typo-body-l-font-style: normal;
        --plasma-typo-body-l-letter-spacing: normal;
        --plasma-typo-body-m-font-family: var(--plasma-typo-display-font-family);
        --plasma-typo-body-m-font-style: normal;
        --plasma-typo-body-m-letter-spacing: normal;
        --plasma-typo-body-s-font-family: var(--plasma-typo-display-font-family);
        --plasma-typo-body-s-font-style: normal;
        --plasma-typo-body-s-letter-spacing: normal;
        --plasma-typo-body-xs-font-family: var(--plasma-typo-display-font-family);
        --plasma-typo-body-xs-font-style: normal;
        --plasma-typo-body-xs-letter-spacing: normal;
        --plasma-typo-body-xxs-font-family: var(--plasma-typo-display-font-family);
